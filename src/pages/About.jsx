  ...
  return (
    <div className=' bg-black pt-25 px-10 md:px-20'>
      ...
      <div className="flex flex-col lg:flex-row items-center lg:items-start gap-10 max-w-6xl mx-auto">
        {/* Image */}
        <img
          src="public/2dcaec58-450a-0df9-7a18-1464f00bcf6a.jpeg" 
          alt="Raj Shamani"
    ...
    <div className=" py-10 px-4 md:px-20 text-center pt-22">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 justify-center items-center pb-10">
        <img src="public/Screenshot 2025-07-24 014827.png" alt="Award 1" className="rounded-lg shadow-lg" />
        <img src="public/Screenshot 2025-07-24 014842.png" alt="Award 2" className="rounded-lg shadow-lg" />
        <img src="public/Screenshot 2025-07-24 014856.png" alt="Award 3" className="rounded-lg shadow-lg" />
        <img src="public/Screenshot 2025-07-24 014904.png" alt="Award 4" className="rounded-lg shadow-lg" />
      </div>
    </div>
    </div>
  )
